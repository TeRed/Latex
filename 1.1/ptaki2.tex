\documentclass[a4paper,10pt,twocolumn,landscape,twoside]{report}
...
\marginsize{5.5cm}{2.5cm}{2.5cm}{5.5cm}
...
\chapter{Rodzina jaskółkowatych}
\label{cha:rodzinajaskolkowatych}

\section{Jaskółka dymówka}
\label{sec:jaskolkadymowka}
...
\section{Jaskółka oknówka}
\label{sec:jaskolkaoknowka}
